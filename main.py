...
class InverseKinematics:
    ...
    def _x(self, t1, t2):
        return self.l1 * cos(t1) + self.l2 * cos(t1 + t2)

    def _y(self, t1, t2):
        return self.l1 * sin(t1) + self.l2 * sin(t1 + t2)
...
# for jacobian
    ...
    def _dx_dt2(self, t1, t2):
        return -self.l2 * sin(t1 + t2)
    
    def _dy_dt1(self, t1, t2):
        return self.l1 * cos(t1) + self.l2 * cos(t1 + t2)
    
    def _dy_dt2(self, t1, t2):
        return self.l2 * cos(t1 + t2)

    def forward_k(self, t1, t2) -> tuple(float, float):
        """
